...
public class Block {
    ...
    public static final Block netherrack = new Block(196, 963, net.minecraft.a.a.d.C_c.d).b(0.4f).setName("Netherrack").setStepSound(aF);
    public static final Block soulSand = new Block(197, 964, net.minecraft.a.a.d.C_c.m).b(0.5f).setName("Soul Sand").setStepSound(aD);
    public static final Block glowStone = new Block(198, 965, net.minecraft.a.a.d.C_c.d).b(0.3f).c(1.0f).setName("\u00a7eGlowstone").setStepSound(aH);
    public static final Block glowingObsidian = new Block(199, 966, net.minecraft.a.a.d.C_c.d).b(10.0f).a(2000.0f).c(0.75f).setName("\u00a7dGlowing Obsidian").setStepSound(aF);
