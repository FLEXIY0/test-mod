...
public class Block {
    ...
    public static final Block netherrack = new Block(196, 963, net.minecraft.a.a.d.Material.d).b(0.4f).setName("Netherrack").setStepSound(aF);
    public static final Block soulSand = new Block(197, 964, net.minecraft.a.a.d.Material.m).b(0.5f).setName("Soul Sand").setStepSound(aD);
    public static final Block glowStone = new Block(198, 965, net.minecraft.a.a.d.Material.d).b(0.3f).c(1.0f).setName("\u00a7eGlowstone").setStepSound(aH);
    public static final Block glowingObsidian = new Block(199, 966, net.minecraft.a.a.d.Material.d).b(10.0f).a(2000.0f).c(0.75f).setName("\u00a7dGlowing Obsidian").setStepSound(aF);
    public static final Block netherReactorCore = new net.minecraft.game.level.block.machines.BlockNetherReactorCore(200, 960).b(3.0f).a(10.0f).setName("\u00a7cNether Reactor Core").setStepSound(aF);
    // Cauldron (ReIndev port): side 967, top-empty 968, top-water 969, bottom 970
    public static final Block cauldron = new net.minecraft.game.level.block.machines.BlockCauldron(201, 967, 968, 969, 970).b(2.0f).a(5.0f).setName("Cauldron").setStepSound(aF);
