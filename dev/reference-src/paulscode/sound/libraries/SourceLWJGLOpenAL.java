...
extends Source {
     ...
     * Enabled aggressive block sorting
     */
    public void play(Channel object) {
        int n;
        if (!this.active()) {
            if (this.toLoop) {
                this.toPlay = true;
        ...
        if (!this.playing()) {
            if (this.toStream && !bl) {
                ...
                if ((object = this.codec.getAudioFormat()) == null) {
                ...
                this.channelOpenAL.setFormat(n, (int)((AudioFormat)object).getSampleRate());
                this.preLoad = true;
            }
            this.channel.play();
            if (this.pitch != 1.0f) {
