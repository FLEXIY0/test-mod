...
public class Comment {
   ...
   public String query(String var1, int var2) {
      int var4;
      if ((var4 = this.query(var1.getBytes(), var2)) == -1) {
         return null;
      } else {
         byte[] var5 = this.user_comments[var4];

         for (int var3 = 0; var3 < this.comment_lengths[var4]; var3++) {
            if (var5[var3] == 61) {
               return new String(var5, var3 + 1, this.comment_lengths[var4] - (var3 + 1));
            }
         }
   ...
   private int query(byte[] var1, int var2) {
      int var3 = 0;
      int var4;
      byte[] var5 = new byte[var4 = var1.length + 1];
      System.arraycopy(var1, 0, var5, 0, var1.length);
      var5[var1.length] = 61;

      for (int var6 = 0; var6 < this.comments; var6++) {
         if (tagcompare(this.user_comments[var6], var5, var4)) {
            if (var2 == var3) {
               return var6;
            }
   ...
   int unpack(Buffer var1) {
      ...
      if ((var2 = var1.read(32)) < 0) {
         ...
         if (this.comments < 0) {
            ...
            for (int var4 = 0; var4 < this.comments; var4++) {
               int var3;
               if ((var3 = var1.read(32)) < 0) {
                  this.clear();
                  return -1;
               }

               this.comment_lengths[var4] = var3;
               this.user_comments[var4] = new byte[var3 + 1];
               var1.read(this.user_comments[var4], var3);
            }
