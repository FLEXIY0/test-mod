...
public class DspState {
         ...
         case 0:
            ...
            for (int var5 = 0; var5 < var2; var5++) {
               ...
               var6 = (float)Math.sin(
                  (double)(
                     (float)(
                        (double)((var6 = (float)Math.sin((double)((float)(((double)var5 + 0.5) / (double)var2 * (float) Math.PI / 2.0)))) * var6)
                           * (float) (Math.PI / 2)
                     )
                  )
               );
            ...
            for (int var9 = var0 + var2; var9 < var1; var9++) {
               var4[var9] = 1.0F;
            }

            for (int var10 = 0; var10 < var3; var10++) {
               float var12;
               var12 = (float)Math.sin(
                  (double)(
                     (float)(
                        (double)((var12 = (float)Math.sin((double)((float)(((double)(var3 - var10) - 0.5) / (double)var3 * (float) Math.PI / 2.0)))) * var12)
                           * (float) (Math.PI / 2)
                     )
                  )
               );
               var4[var10 + var1] = var12;
            }
   ...
   int init(Info var1, boolean var2) {
      ...
      for (int var8 = 0; var8 < var1.modes; var8++) {
         int var3 = var1.mode_param[var8].mapping;
         int var4 = var1.map_type[var3];
         this.mode[var8] = FuncMapping.mapping_P[var4].look(this, var1.mode_param[var8], var1.map_param[var3]);
      }
   ...
   public int synthesis_blockin(Block var1) {
      ...
      this.W = var1.W;
      this.nW = -1;
      this.glue_bits = this.glue_bits + (long)var1.glue_bits;
      this.time_bits = this.time_bits + (long)var1.time_bits;
      this.floor_bits = this.floor_bits + (long)var1.floor_bits;
      this.res_bits = this.res_bits + (long)var1.res_bits;
      if (this.sequence + 1L != var1.sequence) {
         this.granulepos = -1L;
      }

      this.sequence = var1.sequence;
      int var11 = this.vi.blocksizes[this.W];
      int var4;
      int var12;
      int var5 = (var4 = (var12 = this.centerW + this.vi.blocksizes[this.lW] / 4 + var11 / 4) - var11 / 2) + var11;
      int var6 = 0;
      int var7 = 0;
      ...
      switch (this.W) {
         case 0:
            ...
            break;
         case 1:
            var7 = (var6 = this.vi.blocksizes[1] / 4 - this.vi.blocksizes[this.lW] / 4) + this.vi.blocksizes[this.lW] / 2;
      }

      for (int var13 = 0; var13 < this.vi.channels; var13++) {
         int var14;
         for (var14 = var6; var14 < var7; var14++) {
            this.pcm[var13][var4 + var14] = this.pcm[var13][var4 + var14] + var1.pcm[var13][var14];
         }

         while (var14 < var11) {
            this.pcm[var13][var4 + var14] = var1.pcm[var13][var14];
            var14++;
         }
      }
      ...
      label55: {
         if (this.granulepos != -1L) {
            this.granulepos = this.granulepos + (long)(var12 - this.centerW);
            if (var1.granulepos == -1L || this.granulepos == var1.granulepos) {
               break label55;
            }

            if (this.granulepos > var1.granulepos && var1.eofflag != 0) {
               var12 = (int)((long)var12 - (this.granulepos - var1.granulepos));
            }
         }
