...
public class Info {
    ...
    int unpack_books(Buffer buffer) {
        ...
        for (n = 0; n < this.times; ++n) {
            ...
            if (this.time_type[n] < 0 || this.time_type[n] > 0) {
                this.clear();
                return -1;
            }
        ...
        for (n = 0; n < this.maps; ++n) {
            ...
            if (this.map_type[n] < 0 || this.map_type[n] > 0) {
                this.clear();
                return -1;
            }
        ...
        for (n = 0; n < this.modes; ++n) {
            ...
            if (this.mode_param[n].windowtype <= 0 && this.mode_param[n].transformtype <= 0 && this.mode_param[n].mapping < this.maps) continue;
            this.clear();
            return -1;
        }
        if (buffer.read(1) != 1) {
    ...
    public int blocksize(Packet packet) {
        ...
        if ((n = buffer.read(n)) == -1) {
            return -136;
        }
        return this.blocksizes[this.mode_param[n].blockflag];
    }
