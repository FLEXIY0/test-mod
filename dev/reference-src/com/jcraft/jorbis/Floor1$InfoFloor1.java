...
class Floor1$InfoFloor1 {
    ...
    Object copy_info() {
        ...
        new Floor1$InfoFloor1(this.this$0).partitions = floor1$InfoFloor1.partitions;
        ...
        for (int i = 0; i < 16; ++i) {
            System.arraycopy(floor1$InfoFloor1.class_subbook[i], 0, floor1$InfoFloor12.class_subbook[i], 0, 8);
        }
