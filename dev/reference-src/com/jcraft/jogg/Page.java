...
public class Page {
      ...
      return (
               (
                        (
                                 (
                                          (
                                                   ((long)(this.header_base[this.header + 13] & 255) << 8 | (long)(this.header_base[this.header + 12] & 255))
                                                         << 8
                                                      | (long)(this.header_base[this.header + 11] & 255)
                                                )
                                                << 8
                                             | (long)(this.header_base[this.header + 10] & 255)
                                       )
                                       << 8
                                    | (long)(this.header_base[this.header + 9] & 255)
                              )
                              << 8
                           | (long)(this.header_base[this.header + 8] & 255)
                     )
                     << 8
                  | (long)(this.header_base[this.header + 7] & 255)
            )
            << 8
         | (long)(this.header_base[this.header + 6] & 255);
   }
   ...
   void checksum() {
      ...
      for (int var2 = 0; var2 < this.header_len; var2++) {
         var1 = var1 << 8 ^ crc_lookup[var1 >>> 24 ^ this.header_base[this.header + var2] & 255];
      }

      for (int var3 = 0; var3 < this.body_len; var3++) {
         var1 = var1 << 8 ^ crc_lookup[var1 >>> 24 ^ this.body_base[this.body + var3] & 255];
      }
