...
public class StreamState {
   ...
   public int packetout(Packet var1) {
      ...
      if (this.lacing_packet <= var2) {
         ...
         int var4;
         for (var4 = var3 + 0; var3 == 255; var4 += var3) {
            int var5;
            var3 = (var5 = this.lacing_vals[++var2]) & 0xFF;
            if ((var5 & 512) != 0) {
               var1.e_o_s = 512;
            }
         }
   ...
   public int pagein(Page var1) {
      ...
      int var18 = var1.pageno();
      int var15 = var2[var3 + 26] & 255;
      int var16 = this.lacing_returned;
      int var17 = this.body_returned;
      if (this.body_returned != 0) {
         this.body_fill -= var17;
         if (this.body_fill != 0) {
            System.arraycopy(this.body_data, var17, this.body_data, 0, this.body_fill);
         }
      ...
      if (var16 != 0) {
         if (this.lacing_fill - var16 != 0) {
            System.arraycopy(this.lacing_vals, var16, this.lacing_vals, 0, this.lacing_fill - var16);
            System.arraycopy(this.granule_vals, var16, this.granule_vals, 0, this.lacing_fill - var16);
         }

         this.lacing_fill -= var16;
         this.lacing_packet -= var16;
      ...
      if (var14 != this.serialno) {
         ...
         this.lacing_expand(var15 + 1);
         if (var18 != this.pageno) {
            ...
            if (var9 != 0) {
               for (var10 = 0; var7 < var15; var7++) {
                  var17 = var2[var3 + 27 + var7] & 255;
                  var5 += var17;
                  var6 -= var17;
                  if (var17 < 255) {
                     var7++;
         ...
         while (var7 < var15) {
            var17 = var2[var3 + 27 + var7] & 255;
            this.lacing_vals[this.lacing_fill] = var17;
   ...
   public int flush(Page var1) {
      int var2 = this.lacing_fill > 255 ? 255 : this.lacing_fill;
      int var4 = 0;
      int var5 = 0;
      ...
      if (var2 == 0) {
         ...
         if (this.b_o_s == 0) {
            ...
            for (var3 = 0; var3 < var2 && var5 <= 4096; var3++) {
               var5 += this.lacing_vals[var3] & 0xFF;
         ...
         for (int var9 = 6; var9 < 14; var9++) {
            this.header[var9] = (byte)((int)var7);
            var7 >>>= 8;
         }
         ...
         System.arraycopy(this.lacing_vals, var3, this.lacing_vals, 0, this.lacing_fill << 2);
         System.arraycopy(this.granule_vals, var3, this.granule_vals, 0, this.lacing_fill << 3);
         this.body_returned += var4;
         var1.checksum();
         return 1;
      }
