...
extends C_x {
    ...
    public void b(C_g c_g, int n, int n2, int n3) {
        ...
        if ((n5 == C_x.pulleyBase.at || n5 == C_x.pulleyStickyBase.at || n5 == C_x.pulleyBaseActive.at || n5 == C_x.pulleyStickyBaseActive.at) && BlockPistonBase.isExtended(by = c_g.e(n, n2, n3))) {
            if (c_g.gamemode == 0) {
                C_x.c[n5].f(c_g, n, n2, n3, by);
            }
            c_g.b(n, n2, n3, 0);
        }
    }
    ...
    public void b(C_g c_g, int n, int n2, int n3, int n4) {
        ...
        if (n6 != C_x.pulleyBase.at && n6 != C_x.pulleyStickyBase.at && n6 != C_x.pulleyBaseActive.at && n6 != C_x.pulleyStickyBaseActive.at) {
            c_g.b(n, n2, n3, 0);
        } else {
            C_x.c[n6].b(c_g, n - C_d.offsetsXForSide[n5], n2 - C_d.offsetsYForSide[n5], n3 - C_d.offsetsZForSide[n5], n4);
        }
    }
