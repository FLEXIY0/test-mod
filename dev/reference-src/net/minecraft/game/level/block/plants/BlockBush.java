...
extends BlockFlower {
    ...
    public boolean a(World c_g, int n, int n2, int n3, EntityPlayer entityPlayer) {
        ...
        EntityItem c_b = new EntityItem(c_g, (float)n + f, (float)n2 + f2, (float)n3 + f3, new ItemStack(Item.berry));
        new EntityItem(c_g, (float)n + f, (float)n2 + f2, (float)n3 + f3, new ItemStack(Item.berry)).O = 10;
    ...
    public void a(World c_g, int n, int n2, int n3, int n4, float f) {
        ...
        if (!c_g.multiplayerWorld && n4 == 1) {
            ...
            EntityItem c_b = new EntityItem(c_g, (float)n + f2, (float)n2 + f3, (float)n3 + f4, new ItemStack(Item.berry));
            new EntityItem(c_g, (float)n + f2, (float)n2 + f3, (float)n3 + f4, new ItemStack(Item.berry)).O = 10;
            c_g.spawnEntityInWorld(c_b);
        }
    }
