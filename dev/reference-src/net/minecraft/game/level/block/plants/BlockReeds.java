...
extends C_x {
    ...
    public boolean a(C_g c_g, int n, int n2, int n3) {
        ...
        return n4 == this.at ? true : (n4 != C_x.j.at && n4 != C_x.k.at ? false : (c_g.f(n - 1, n2 - 1, n3) == C_c.f ? true : (c_g.f(n + 1, n2 - 1, n3) == C_c.f ? true : (c_g.f(n, n2 - 1, n3 - 1) == C_c.f ? true : c_g.f(n, n2 - 1, n3 + 1) == C_c.f))));
    }
    ...
    protected final void checkBlockCoordValid(C_g c_g, int n, int n2, int n3) {
