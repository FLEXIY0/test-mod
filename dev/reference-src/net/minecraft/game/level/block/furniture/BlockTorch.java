...
extends C_x {
    ...
    public final boolean a(C_g c_g, int n, int n2, int n3) {
        ...
        C_x c_x = C_x.c[n4];
        if (c_x == C_x.table || c_x == C_x.fence || c_x instanceof BlockWall || c_x == C_x.stairUpsideDown) {
            return true;
        }
    ...
    public final void a(C_g c_g, int n, int n2, int n3, Random random) {
        ...
        int n4 = 251 - c_g.E * 50;
        if (c_g.isBloodMoon() && c_g.E != 0 && random.nextInt(n4) == 0 && this == C_x.af) {
            byte by = c_g.e(n, n2, n3);
            c_g.setBlockAndMetadataWithNotify(n, n2, n3, C_x.unlitTorch.at, by);
        }
    }
    ...
    private boolean dropTorchIfCantStay(C_g c_g, int n, int n2, int n3) {
    ...
    public final void b(C_g c_g, int n, int n2, int n3, Random random) {
        ...
        if (by == 1) {
            ...
            c_g.a(this == C_x.torchHell ? "hell" : "flame", f - 0.27f, f2 + 0.22f, f3, 0.0f, 0.0f, 0.0f);
        } else if (by == 2) {
            c_g.a("smoke", f + 0.27f, f2 + 0.22f, f3, 0.0f, 0.0f, 0.0f);
            c_g.a(this == C_x.torchHell ? "hell" : "flame", f + 0.27f, f2 + 0.22f, f3, 0.0f, 0.0f, 0.0f);
        } else if (by == 3) {
            c_g.a("smoke", f, f2 + 0.22f, f3 - 0.27f, 0.0f, 0.0f, 0.0f);
            c_g.a(this == C_x.torchHell ? "hell" : "flame", f, f2 + 0.22f, f3 - 0.27f, 0.0f, 0.0f, 0.0f);
        } else if (by == 4) {
            c_g.a("smoke", f, f2 + 0.22f, f3 + 0.27f, 0.0f, 0.0f, 0.0f);
            c_g.a(this == C_x.torchHell ? "hell" : "flame", f, f2 + 0.22f, f3 + 0.27f, 0.0f, 0.0f, 0.0f);
        } else {
            c_g.a("smoke", f, f2, f3, 0.0f, 0.0f, 0.0f);
            c_g.a(this == C_x.torchHell ? "hell" : "flame", f, f2, f3, 0.0f, 0.0f, 0.0f);
        }
    }
}
