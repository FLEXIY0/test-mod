...
extends C_f {
    ...
    public final void a(net.minecraft.a.c.C_b c_b, float f, float f2, float f3, float f4, float f5) {
        ...
        GL11.glRotatef((float)(c_a.p + (c_a.n - c_a.p) * f5 - 90.0f), (float)0.0f, (float)1.0f, (float)0.0f);
        GL11.glRotatef((float)(c_a.q + (c_a.o - c_a.q) * f5), (float)0.0f, (float)0.0f, (float)1.0f);
        C_d c_d = C_d.a;
        ...
        float f7 = (float)(0 + c_a.arrowType * 10) / 32.0f;
        float f8 = (float)(5 + c_a.arrowType * 10) / 32.0f;
        float f9 = 0.15625f;
        float f10 = (float)(5 + c_a.arrowType * 10) / 32.0f;
        float f11 = (float)(10 + c_a.arrowType * 10) / 32.0f;
