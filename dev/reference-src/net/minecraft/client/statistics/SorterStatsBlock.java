...
public class SorterStatsBlock
implements Comparator<Object> {
    final C_bs statsGUI;
    final C_bo slotStatsBlockGUI;

    public SorterStatsBlock(C_bo c_bo, C_bs c_bs) {
        this.slotStatsBlockGUI = c_bo;
        this.statsGUI = c_bs;
    }
    ...
    public int readStatList(StatCrafting statCrafting, StatCrafting statCrafting2) {
        ...
        if (statBase != null || statBase2 != null) {
            ...
            int n4 = C_bs.getStatsFileWriter(this.slotStatsBlockGUI.theStats).getStatCount(statBase);
            if (n4 != (n3 = C_bs.getStatsFileWriter(this.slotStatsBlockGUI.theStats).getStatCount(statBase2))) {
                return (n4 - n3) * this.slotStatsBlockGUI.selectedStat;
            }
        }
        return n - n2;
    }
