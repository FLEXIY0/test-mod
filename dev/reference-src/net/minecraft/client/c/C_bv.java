...
public final class C_bv extends GuiScreen {
   private String screenTitle = "Graphics";
   ...
   public final void b() {
      ...
      for (int var1 = 4; var1 < this.options.t; var1++) {
         this.e.add(new GuiButton(var1, this.c / 2 - 65 + var1 % 2 * 160, this.d / 6 - 24 + 24 * (var1 >> 1), 60, 20, this.options.b(var1)));
      }
   ...
   protected final void a(GuiButton var1) {
      if (var1.c) {
         if (var1.b < 100) {
            this.options.b(var1.b, 1);
            var1.a = this.options.b(var1.b);
            if (var1.b == 7) {
               ScaledResolution var2 = new ScaledResolution(this.b.w, this.b.b, this.b.c);
               int var3 = var2.a();
               int var4 = var2.b();
               this.a(this.b, var3, var4);
            }
         }
   ...
   public final void a(int var1, int var2, float var3) {
      ...
      for (int var10 = 0; var10 < var30.size() - 6; var10++) {
         ...
         if (var13.d) {
            ...
            GuiButton.drawStringAlt(var16, this.options.setOptionDesc(var13.b), var13.g, var13.i + (var13.f - 8) / 2, 14737632);
         }
      }
      ...
      for (int var37 = 14; var37 <= this.e.size() - 1; var37++) {
