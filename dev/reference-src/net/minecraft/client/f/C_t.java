...
extends C_k {
    ...
    public C_t(C_g c_g, float f, float f2, float f3, float f4, float f5, float f6) {
        this(c_g, f, f2, f3, f4, f5, f6, 2.0f);
    }

    public C_t(C_g c_g, float f, float f2, float f3, float f4, float f5, float f6, float f7) {
