...
extends Entity {
    ...
    public C_f(World c_g, float f, float f2, float f3) {
        ...
        if (c_g.E >= 2) {
            ...
            if (c_g.a(n3, n2 = MathHelper.a((double)f2), n = MathHelper.a((double)f3)) == 0 && Block.ag.a(c_g, n3, n2, n) && !c_g.multiplayerWorld) {
                c_g.b(n3, n2, n, Block.ag.at);
            }
            if (c_g.a(n3, n2 - 1, n) != Block.rod.at) {
                for (n3 = 0; n3 < 4; ++n3) {
                    int n4;
                    n2 = MathHelper.a((double)f) + this.G.nextInt(3) - 1;
                    if (c_g.a(n2, n = MathHelper.a((double)f2) + this.G.nextInt(3) - 1, n4 = MathHelper.a((double)f3) + this.G.nextInt(3) - 1) != 0 || !Block.ag.a(c_g, n2, n, n4)) continue;
                    c_g.b(n2, n, n4, Block.ag.at);
                }
            }
        }
    }
    ...
    public void b_() {
        ...
        if (this.thunderAge < 0) {
            if (this.thunderFlash == 0) {
                ...
                if (this.d.a(n3, n = MathHelper.a((double)this.i), n2 = MathHelper.a((double)this.j)) == 0 && Block.ag.a(this.d, n3, n, n2)) {
                    this.d.b(n3, n, n2, Block.ag.at);
                }
            }
        }
        if (this.thunderAge >= 0) {
