...
extends C_c {
    ...
    protected float a(int n, int n2, int n3) {
        return this.d.a(n, n2 - 1, n3) == C_x.j.at ? 10.0f : this.d.c(n, n2, n3) - 0.5f;
    }
    ...
    public boolean a(float f, float f2, float f3) {
        return this.d.d((int)f, (int)f2, (int)f3) > 8 && this.d.a((int)f, (int)f2 - 1, (int)f3) == C_x.j.at && super.a(f, f2, f3);
    }
