...
extends C_e {
    ...
    public C_l(C_g c_g, float f, float f2, float f3) {
        super(c_g, f, f2, f3);
        this.V = "/mob/termite.png";
        this.a(0.9f, 0.9f);
        this.am = 1.3f;
    ...
    public final boolean a(float f, float f2, float f3) {
        ...
        return this.d.a((int)f, (int)f2 - 1, (int)f3) == C_x.mycelium.at && this.d.d(this.r) && this.d.getCollidingBoundingBoxes(this, this.r).size() == 0 && !this.d.b(this.r);
    }
    ...
    public float a(int n, int n2, int n3) {
        return this.d.a(n, n2 - 1, n3) == C_x.mycelium.at ? 10.0f : super.a(n, n2, n3);
    }
