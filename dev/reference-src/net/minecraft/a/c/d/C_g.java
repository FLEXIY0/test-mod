...
extends C_b {
    ...
    public C_g(net.minecraft.a.a.C_g c_g, C_e c_e, int n, int n2, int n3, int n4, float f) {
        super(c_g);
        this.owner = c_e;
        this.a(0.5f, 0.5f);
        ...
        this.setArrowHeading(this.k, this.l, this.m, f * 1.5f, 1.0f);
    }
    ...
    public final void b_() {
        ...
        if (n > 0) {
            ...
            object = C_x.c[n].getCollisionBoundingBoxFromPool(this.d, this.xTile, this.yTile, this.zTile);
            if (object != null && ((net.minecraft.a.d.C_b)object).isVecInside(new C_a(this.h, this.i, this.j))) {
                this.inGround = true;
            }
        }
        ...
        object = new C_a(this.h, this.i, this.j);
        C_a c_a = new C_a(this.h + this.k, this.i + this.l, this.j + this.m);
        C_c c_c = this.d.a((C_a)object, c_a);
        object = new C_a(this.h, this.i, this.j);
        ...
        for (int i = 0; i < list.size(); ++i) {
            C_c c_c2;
            c_b = list.get(i);
            if (!c_b.d() || c_b == this.owner && this.ticksInAir < 5 || (c_c2 = c_b.r.b(0.3f, 0.3f, 0.3f).a((C_a)object, c_a)) == null || !((f = ((C_a)object).b(c_c2.f)) < f2) && f2 != 0.0f) continue;
            c_b2 = c_b;
            f2 = f;
        }
        if (c_b2 != null) {
        ...
        if (c_c != null) {
            if (c_c.g != null) {
                if (!c_c.g.deflectProjectile) {
                    if (c_c.g.attackEntityFrom(this, this.attack, 0.4f)) {
                        this.d.a(this, "random.drr", 1.0f, 1.2f / (this.G.nextFloat() * 0.2f + 0.9f));
                        this.dmg += 5;
                        c_c.g.stunTimer = 60;
                        if (this.dmg < this.maxDMG) {
                    ...
                    if (c_c.g instanceof EntityPlayer) {
                        c_b = (EntityPlayer)c_c.g;
                        if (((EntityPlayer)c_b).b.charmSlot[0] != null && ((EntityPlayer)c_b).b.charmSlot[0].c == Item.shield.ap) {
                            ((EntityPlayer)c_b).damageItem(1, ((EntityPlayer)c_b).b.charmSlot[0], this.d);
                            if (((EntityPlayer)c_b).b.charmSlot[0].a <= 0) {
                                ((EntityPlayer)c_b).b.charmSlot[0] = null;
                            }
                        }
                    }
                }
                ...
                float f5 = MathHelper.c(this.k * this.k + this.l * this.l + this.m * this.m);
                this.h -= this.k / f5 * 0.05f;
                this.i -= this.l / f5 * 0.05f;
                this.j -= this.m / f5 * 0.05f;
                this.d.a(this, "random.drr", 1.0f, 1.2f / (this.G.nextFloat() * 0.2f + 0.9f));
                this.inGround = true;
                this.arrowShake = 7;
            }
        ...
        if (this.d.l((int)this.h, (int)this.i, (int)this.j) && this.d.season.currentSeason == 2 && this.d.getWindForce() > 0.0f) {
            ...
            switch (this.d.getWindDirection()) {
                case 0: {
                    n2 = 1;
                    this.h += (float)(((double)this.k + (double)((float)n2 * this.d.getWindForce())) * 0.2);
                    break;
                }
                case 1: {
                    n2 = 1;
                    this.j += (float)(((double)this.m + (double)((float)n2 * this.d.getWindForce())) * 0.2);
                    break;
                }
                case 2: {
        ...
        this.i += this.l;
        this.j += this.m;
        float f6 = MathHelper.c(this.k * this.k + this.m * this.m);
        this.n = (float)(Math.atan2(this.k, this.m) * 180.0 / 3.1415927410125732);
        this.o = (float)(Math.atan2(this.l, f6) * 180.0 / 3.1415927410125732);
    ...
    protected final void a(NBTTagCompound nBTTagCompound) {
        ...
        nBTTagCompound.a("ID", this.id);
        nBTTagCompound.a("Damage", this.dmg);
    }
    ...
    protected final void b(NBTTagCompound nBTTagCompound) {
        ...
        this.dmg = nBTTagCompound.d("Damage");
    ...
    public final void a(EntityPlayer entityPlayer) {
        int n = this.id;
        if (this.inGround && this.arrowShake <= 0 && !this.u && !this.d.multiplayerWorld && entityPlayer.b.a(new ItemStack(n, 1, this.dmg))) {
