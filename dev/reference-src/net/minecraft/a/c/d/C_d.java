...
extends Entity {
    ...
    public C_d(World c_g, EntityLiving c_e) {
        super(c_g);
        this.thrower = c_e;
        this.a(0.25f, 0.25f);
    ...
    public void b_() {
        ...
        if (c_c != null) {
            if (c_c.g != null && c_c.g.attackEntityFrom(this.thrower, 2, 0.4f)) {
                c_c.g.J = 100;
            } else if (!(this.d.f((int)this.h, (int)this.i, (int)this.j) instanceof net.minecraft.a.a.d.C_b) && this.d.a((int)this.h, (int)this.i, (int)this.j) == 0) {
                this.d.a((int)this.h, (int)this.i, (int)this.j, Block.ag.at);
            }
            for (int i = 0; i < 8; ++i) {
                this.d.a("smoke", this.h, this.i, this.j, 0.0f, 0.0f, 0.0f);
            }
            this.k();
        }
        for (int i = 0; i < 4; ++i) {
            float f = 0.25f;
            this.d.a("smoke", this.h - this.k * f, this.i - this.l * f, this.j - this.m * f, this.k, this.l, this.m);
            this.d.a("fire", this.h - this.k * f, this.i - this.l * f, this.j - this.m * f, this.k, this.l, this.m);
        }
