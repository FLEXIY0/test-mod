...
extends C_b {
    ...
    public C_a(C_g c_g, C_e c_e, int n, float f) {
        super(c_g);
        this.S = c_e;
        this.a(0.5f, 0.5f);
    ...
    public final void b_() {
        ...
        if (n2 > 0) {
            C_x.c[n2].setBlockBoundsBasedOnState(this.d, this.b, this.O, this.P);
            object = C_x.c[n2].getCollisionBoundingBoxFromPool(this.d, this.b, this.O, this.P);
