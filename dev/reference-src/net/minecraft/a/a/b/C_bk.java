...
extends C_ae {
    ...
    public boolean tryToCreatePortal(C_g c_g, int n, int n2, int n3) {
        ...
        int n6 = 0;
        int n7 = 0;
        if (c_g.a(n - 1, n2, n3) == C_x.ae.at || c_g.a(n + 1, n2, n3) == C_x.ae.at) {
            n6 = 1;
        }
        if (c_g.a(n, n2, n3 - 1) == C_x.ae.at || c_g.a(n, n2, n3 + 1) == C_x.ae.at) {
            n7 = 1;
        }
        if (n6 == n7) {
            return false;
        ...
        for (n5 = -1; n5 <= 2; ++n5) {
            for (n4 = -1; n4 <= 3; ++n4) {
                ...
                if (!(bl ? n8 != C_x.ae.at : n8 != 0 && n8 != C_x.hellfire.at)) continue;
                return false;
            }
        }
        for (n5 = 0; n5 < 2; ++n5) {
            for (n4 = 0; n4 < 3; ++n4) {
                c_g.setBlockAndMetadata(n + n6 * n5, n2 + n4, n3 + n7 * n5, C_x.portal.at, 11);
            }
        }
    ...
    public void b(C_g c_g, int n, int n2, int n3, int n4) {
        ...
        if (c_g.a(n, n7 - 1, n3) != C_x.ae.at) {
            c_g.b(n, n2, n3, 0);
        } else {
            int n8;
            for (n8 = 1; n8 < 4 && c_g.a(n, n7 + n8, n3) == this.at; ++n8) {
            }
            if (n8 == 3 && c_g.a(n, n7 + n8, n3) == C_x.ae.at) {
                boolean bl;
                ...
                if (bl2 && bl) {
                    c_g.b(n, n2, n3, 0);
                } else if (!(c_g.a(n + n5, n2, n3 + n6) == C_x.ae.at && c_g.a(n - n5, n2, n3 - n6) == this.at || c_g.a(n - n5, n2, n3 - n6) == C_x.ae.at && c_g.a(n + n5, n2, n3 + n6) == this.at)) {
                    c_g.b(n, n2, n3, 0);
                }
            } else {
                c_g.b(n, n2, n3, 0);
