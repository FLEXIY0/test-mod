...
extends Block {
    ...
    private boolean canSpread(World c_g, int n, int n2, int n3) {
    ...
    public final void a(World c_g, int n, int n2, int n3, Random random) {
        ...
        } else if (c_g.d(n, n2 + 1, n3) >= 9 && (c_g.a(n = n + random.nextInt(3) - 1, n2 = n2 + random.nextInt(5) - 3, n3 = n3 + random.nextInt(3) - 1) == Block.k.at || c_g.a(n, n2, n3) == Block.j.at) && !c_g.a((float)n, (float)(n2 + 1), (float)n3) && this.canSpread(c_g, n, n2, n3)) {
            c_g.b(n, n2, n3, Block.mycelium.at);
        }
    }
