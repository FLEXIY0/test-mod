        ...
        if (n2 >= 1 && n2 + n4 + 1 <= c_g.c) {
            ...
            if ((n12 == Block.j.at || n12 == Block.k.at) && n2 < c_g.c - n4 - 1) {
                ...
                for (n10 = n2 + n4; n10 >= n2 + n5; --n10) {
                    for (n9 = n - n11; n9 <= n + n11; ++n9) {
                        ...
                        for (int i = n3 - n11; i <= n3 + n11; ++i) {
                            int n13 = i - n3;
                            if (Math.abs(n8) == n11 && Math.abs(n13) == n11 && n11 > 0 || Block.e[c_g.a(n9, n10, i)]) continue;
                            c_g.setBlockAndMetadata(n9, n10, i, Block.z.at, this.leavesMetadata);
                        }
                    }
                ...
                for (n10 = 0; n10 < n4 - 1; ++n10) {
                    ...
                    if (n9 != 0 && n9 != Block.z.at) continue;
                    c_g.setBlockAndMetadata(n, n2 + n10, n3, Block.y.at, this.treeMetadata);
                }
                c_g.cantGrow = false;
                return true;
            }
