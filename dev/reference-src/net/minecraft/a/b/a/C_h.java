...
public final class C_h {
    ...
    private Object[][] b = new Object[][]{{Block.m, Block.l, Item.k, Item.j, Item.l, Item.emerald}, {Item.n, Item.r, Item.m, Item.v, Item.C, Item.swordEmerald}, {Item.spearWood, Item.spearStone, Item.spearSteel, Item.spearDiamond, Item.spearGold, Item.spearEmerald}};
    ...
    public final void a(CraftingManager c_f) {
        ...
        c_f.a(new ItemStack(Item.dartShooter, 1), "#", "#", "X", Character.valueOf('X'), Item.emerald, Character.valueOf('#'), Block.m);
