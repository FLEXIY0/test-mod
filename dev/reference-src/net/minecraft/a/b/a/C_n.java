...
public class C_n {
    public void addRecipes(C_f c_f) {
        for (int i = 0; i < 16; ++i) {
            ...
            c_f.addShapelessRecipe(new ItemStack(Block.glassStained, 1, C_bo.getGlassColor(i)), new ItemStack(Item.dyePowder, 1, i), new ItemStack(Item.b[Block.B.at], 1, 0));
            c_f.addShapelessRecipe(new ItemStack(Block.cloth, 1, 0), new ItemStack(Item.dyePowder, 1, 15), new ItemStack(Item.b[Block.cloth.at], 1, i));
            c_f.addShapelessRecipe(new ItemStack(Block.carpet, 1, 0), new ItemStack(Item.dyePowder, 1, 15), new ItemStack(Item.b[Block.carpet.at], 1, i));
            c_f.addShapelessRecipe(new ItemStack(Block.glassStained, 1, 0), new ItemStack(Item.dyePowder, 1, 15), new ItemStack(Item.b[Block.glassStained.at], 1, i));
        }
        c_f.addShapelessRecipe(new ItemStack(Item.dyePowder, 2, 0), Block.plantRed);
        ...
        c_f.addShapelessRecipe(new ItemStack(Item.dyePowder, 2, 2), Block.plantYellow);
        ...
        c_f.addShapelessRecipe(new ItemStack(Item.dyePowder, 2, 7), Block.plantBlue);
        ...
        c_f.addShapelessRecipe(new ItemStack(Item.dyePowder, 2, 9), Block.plantPurple);
