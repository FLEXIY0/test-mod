...
extends Item {
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer entityPlayer, World c_g, int n, int n2, int n3, int n4) {
        ...
        if (c_g.f(n, n2, n3) == Material.a && c_g.f(n + n6, n2, n3 + n7) == Material.a && c_g.b(n, n2 - 1, n3) && c_g.b(n + n6, n2 - 1, n3 + n7) && c_g.a(n, n2 - 1, n3) != Block.quickSand.at && n + n6 > 0 && n3 + n7 > 0 && n + n6 <= c_g.a - 2 && n3 + n7 <= c_g.b - 2 && n > 0 && n3 > 0 && n <= c_g.a - 2 && n3 <= c_g.b - 2) {
            ...
            String string = Block.bed.getStepSound(this.getPlacedBlockMetadata(itemStack.getItemDamage())).b();
            float f4 = (Block.bed.getStepSound((int)this.getPlacedBlockMetadata((int)itemStack.getItemDamage())).a + 1.0f) / 2.0f;
            c_g.playSoundAtBlock(f, f2, f3, string, f4, Block.bed.getStepSound((int)this.getPlacedBlockMetadata((int)itemStack.getItemDamage())).b * 0.8f);
